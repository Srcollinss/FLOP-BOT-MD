...
const spinner2 = { 
  "interval": 150,
  "frames": ["CANAL https://youtube.com/channel/UCwUkW0bwzL58Ngcw1gEKkmg "]}
...
const banner2 = cfonts.render(('CRIADOR: Sr.Collins\nNOME DO BOT: FLOP-MD\n\nQUALQUER DUVIDA:WA.ME//553398195857\n\nBOA SORTE É APROVEITE  O BOT (◔‿◔)'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`FLOP-BOT MD 1.0`), {
font: 'simple',             
align: 'center',           
...
authorname = 'FLOP-MD 1.0'
packname = '-Sc-'
  
function addMetadata(packname, author) {	
if (!packname) packname = '-Sc-'; if (!author) author = 'FLOP-BOT-MD 1.0';	
...
chyt = `553398195857@s.whatsapp.net`
